...
sidebar context menu or the Window menu.
...
| Apple Shortcuts actions | Not implemented | App Intents metadata is generated by Xcode; this project builds with Swift Package Manager. |
| Plugin system, custom widget canvas | Not implemented | Deferred rather than shipped as a non-functional shell. |
